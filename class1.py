...
class TestingG:
    w = RiotWatcher('RGAPI-86b0a2a1-4576-49aa-801c-ba9a6780719b')

    # check if we have API calls remaining
    print(w.can_make_request())
    print("TEETETETETETETETTEETET")
    ...
    euw = RiotWatcher('RGAPI-86b0a2a1-4576-49aa-801c-ba9a6780719b', default_region=EUROPE_WEST)
